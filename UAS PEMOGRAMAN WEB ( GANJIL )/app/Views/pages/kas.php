...
<div class="container">
  ...
  <div class="row justify-content-start">
    ...
    <?php endif; ?>
    <form action="/pages/uang" method="post">
      <?= csrf_field(); ?>
      <div class="col-6 text-bg-secondary p-3">
        <div class="mb-3">
          ...
          <input type="number" class="form-control <?= ($validation->hasError('nik')) ? 'is-invalid' : ''; ?>" id="nik"
            placeholder="No.KTP" readonly name="nik" value="<?= (old('nik')) ? old('nik') : $warga['nik']; ?>" required>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" id="nama"
            placeholder="Nama" readonly name="nama" value="<?= (old('nama')) ? old('nama') : $warga['nama']; ?>">
          <div class=" invalid-feedback">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control <?= ($validation->hasError('kelamin')) ? 'is-invalid' : ''; ?>"
            id="kelamin" placeholder="kelamin" readonly name="kelamin"
            value="<?= (old('kelamin')) ? old('kelamin') : $warga['kelamin']; ?>">
          <div class=" invalid-feedback">
        ...
        <!-- <div class="mb-3">
          ...
          <select class="form-select mb-3 <?= ($validation->hasError('kelamin')) ? 'is-invalid' : ''; ?>"
            aria-label="Default select example" readonly name="kelamin" required>
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>" id="alamat"
            rows="3" placeholder="Masuk alamat anda..." readonly name="alamat"
            value=""><?= (old('alamat')) ? old('alamat') : $warga['alamat']; ?></textarea>
          <div class="invalid-feedback">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control <?= ($validation->hasError('no_rumah')) ? 'is-invalid' : ''; ?>"
            id="no_rumah" placeholder="No rumah" readonly name="no_rumah"
            value="<?= (old('no_rumah')) ? old('no_rumah') : $warga['no_rumah']; ?>">
          <div class="invalid-feedback">
